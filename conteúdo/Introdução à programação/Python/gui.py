...
def main(page: ft.Page):
    ...
    page.most1 = ft.TextField(value=0, label='Elevador 1', bgcolor=ft.colors.GREEN_200, on_change=mudacor)
    page.most2 = ft.TextField(value=0, label='Elevador 2', bgcolor=ft.colors.GREEN_200, on_change=mudacor)
